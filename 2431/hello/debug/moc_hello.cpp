...
static const char qt_meta_stringdata_hello[] = {
    "hello\0\0on_pushButton_clicked()\0"
...
const QMetaObjectExtraData hello::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject hello::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_hello,
      qt_meta_data_hello, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &hello::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_hello))
